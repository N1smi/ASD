...
TEST(TestSortedTableOnRBTreeLib, CreateDefaultTable) {
...
TEST(TestSortedTableOnRBTreeLib, InsertElements) {
  SortedTableOnRBTree<int, std::string> table;
...
TEST(TestSortedTableOnRBTreeLib, InsertExistentKey) {
  SortedTableOnRBTree<int, std::string> table;
...
TEST(TestSortedTableOnRBTreeLib, EraseElements) {
  SortedTableOnRBTree<int, std::string> table;
  table.insert(1, "One");
  table.insert(2, "Two");
...
TEST(TestSortedTableOnRBTreeLib, EraseElementsNonExistentKey) {
  SortedTableOnRBTree<int, std::string> table;
  table.insert(1, "One");
  table.insert(2, "Two");
  table.insert(3, "Three");
...
TEST(TestSortedTableOnRBTreeLib, FindElements) {
  SortedTableOnRBTree<int, std::string> table;
...
TEST(TestSortedTableOnRBTreeLib, ElementsAreSortedInOrder) {
  SortedTableOnRBTree<int, std::string> table;
